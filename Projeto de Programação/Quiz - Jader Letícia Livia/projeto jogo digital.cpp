/********************************************
Jader Silva Oliveira 1702874
Leticia da Silva Martins 180278x
Livia Eduarda Moreira Grecco 180104x
********************************************/
#include <iostream>
#include <locale.h>
#include <cstdlib>
...
int main()
{
    ...
    Sleep(3000); //Conta o tempo
    system("cls"); //Limpa a tela

    while ( iEscolha < 4 )// roda o programa enquanto a variavel não for 4
    {
    ...
    case 1:
        ...
        cout << "Você acertou " << iPont << " pergunta(as)" << endl;
