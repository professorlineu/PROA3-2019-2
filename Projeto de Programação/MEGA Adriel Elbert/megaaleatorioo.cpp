 ...
 ofstream myfile ("arquivo.txt", ios_base::app);
    ...
    if (myfile.is_open())
    {
       ...
       cin>> sTexto;
        ...
        cout <<"\nHoje é o seu dia!!!!!!               - 50 a 60 pontos";
        cout <<"\nNada mal. Você está quase lá         - 35 a 49 pontos";
        cout <<"\nAté que você foi bem                 - 20 a 34 pontos";
        cout <<"\nHoje não é o seu dia de sorte        - 1 a 19 pontos";
        cout << endl;
