...
int main ()
{
    ...
    case 1:     //Dificuldade normal
        ...
        for (k=0; k<3; k++) //Laço para as jogadas
        {

            // Parada quando alguém ganha
            do
            {
                ...
                //Horizontal completa <<<<<<<< criar 'for' variando a linha colocar if no laço de teste
