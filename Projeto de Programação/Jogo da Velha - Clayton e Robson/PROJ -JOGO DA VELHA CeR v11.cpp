...
int main ()
{
    ...
    case 1:     //Dificuldade normal
        ...
        do
        {
            ...
            //Horizontal completa
            else if ((cJogoVelha [0][0] == cComp) && (cJogoVelha [0][1] == cComp) && (cJogoVelha [0][2] == cComp))
            {
                cout <<"\n\tVocê perdeu para o computador!";
                m++;
            }
            ...
            //Verificação se deu velha (Ninguém ganhou e não tem mais espaço)
            if ((m==0) && (k==0))
            {
                cout <<"\n\tDeu VELHA!";
                m++;
            ...
            if((iJogadaUsu > iJogadaComp) && (k!=0) && (m==0))
            {
        ...
        while (( m == 0) && (k != 0)); //Fim do laço para as jogadas (Se ninguém ganhou e ainda tem espaço na matriz)
