...
int main()
{
    ...
    while ( i < 8)
    {
        ...
        cout << "Mostre a idade da pessoa: " << endl;
        cin >> idade;

        if ( idade <= 15 )
        {
            cout << "Essa pessoa estara na 1° faixa etária! " << endl;
            fcont1++;
        }

        else if (idade >= 16 and idade <= 30)
        {
            cout << "Essa pessoa estará na 2° faixa etária! " << endl;
        }

        if (idade >= 31 and idade <= 45)
        {
            cout << "Essa pessoa estará na 3° faixa etária! " << endl;
        }
        else if (idade >= 46 and idade <= 60)
        {
            cout << "Essa pessoa estará na 4° faixa etária! " << endl;
        }

        if (idade > 60)
        {
            cout << "Essa pessoa estará na 5° faixa etária! " << endl;
                fcont2++;
        }
